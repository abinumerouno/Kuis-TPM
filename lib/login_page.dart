...
import 'package:kuistpm/home_page.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget _createImage(){
    return Container(
      child: Image.network("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTBBTAnNqQ1OAWMSQPwrO-PPo2oEYoWWt-rsQ&usqp=CAU"),
    );
  }
  ...
  Widget _loginButton(BuildContext context) {
    return Container(
      ...
      child: ElevatedButton(
        ...
        onPressed: () {
          String text = "";
          if (username == "abinumerouno" && password == "1827") {
            setState(() {
              text = "Login Success";
              isLoginSuccess = true;
            });
